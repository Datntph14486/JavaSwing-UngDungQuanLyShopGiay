 ...
 */
public class XacNhanCaLamViec extends javax.swing.JFrame {

    NhanVien_DAO dao;
    private String key1;

    public XacNhanCaLamViec() {
        initComponents();
    ...
    public XacNhanCaLamViec(String key) {
        initComponents();
        setLocationRelativeTo(null);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        dao = new NhanVien_DAO();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("XÁC NHẬN CA LÀM VIỆC");
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        if (MsgBox.comfirm(this, "Bạn có chắc chắn muốn Xác nhận ca làm việc: " + key1 + " này ?")) {
            ...
            if (nv == null) {
                ...
                MsgBox.alert(this, "Bạn không có quyền thay đổi xác nhận ca làm việc !");
            } else {
                update();
            }
        }
    ...
    private void btnHuyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHuyActionPerformed
        if (MsgBox.comfirm(this, "Hủy xác nhận ca làm việc ?")) {
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XacNhanCaLamViec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new XacNhanCaLamViec().setVisible(true);
            }
        });
    }
    ...
    void update() {
        try {
            jdbcHelper.update("UPDATE GIAOCA\n"
                    + "SET    TRANGTHAI = 1\n"
                    + "WHERE   MAGIAOCA = ?", key1);
            MsgBox.alert(this, "Thay đổi trạng thái => xác nhận ca làm thành công!");
            this.dispose();
        } catch (Exception e) {
            e.printStackTrace();
            MsgBox.alert(this, "Lỗi thay đổi xác nhận ca làm việc!");
        }
    }
}
